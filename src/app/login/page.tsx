    ...
    <main className="grid min-h-screen lg:grid-cols-[1fr_1.1fr]">
      <aside className="relative hidden overflow-hidden bg-navy-950 p-12 text-white lg:flex lg:flex-col">
        ...
        <div className="relative mt-auto">
          <h1 className="font-display text-4xl leading-tight font-black">
            Welcome back to your <span className="text-gold-400">admission journey</span>.
          </h1>
          <p className="mt-4 max-w-md text-sm leading-relaxed text-navy-200">
            Track applications, upload documents, chat with your officer and pay outstanding fees — all in
            one secure place.
          </p>
          <ul className="mt-8 space-y-2 text-sm text-navy-100">
            <li>· Live status: verified → submitted → offer → enrolled</li>
            <li>· Private document vault, per student</li>
            <li>· Paynow receipts & payment history</li>
          </ul>
        </div>
      ...
      <section className="flex items-center justify-center px-4 py-16 sm:px-8">
        <div className="w-full max-w-md">
          <p className="text-xs font-bold tracking-[0.25em] text-zim-green uppercase">Student & staff portal</p>
          <h2 className="mt-2 font-display text-3xl font-black tracking-tight text-navy-900">Sign in</h2>
          <p className="mt-2 text-sm text-ink-soft">
            New here?{" "}
            <Link href="/signup" className="font-bold text-navy-700 hover:underline">
